...
elementRemoved1 = cargoHold.shift();
console.log(elementRemoved1);
console.log(cargoHold);
...
console.log(`The Final Array: ${cargoHold}, Array Length: ${cargoHold.length}`);